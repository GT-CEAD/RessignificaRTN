...
Busca_URL_Relatorio <- function(data_sel){
  ...
  #URL_relatorio<-gsub("http://apickan.tesouro.gov.br", "https://www.tesourotransparente.gov.br",tb_ckan_rel$results[[1]]$url)
  URL_relatorio<-gsub("http://apickan.tesouro.gov.br", "https://apickan.tesouro.gov.br",tb_ckan_rel$results[[1]]$url)
  
  
  
  #URL_relatorio<-gsub("http://www.tesourotransparente.gov.br","https://www.tesourotransparente.gov.br",tb_ckan_rel$results[[1]]$url)
  print(paste("URL após substituição",URL_relatorio))
  URL_relatorio
